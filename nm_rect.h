...
void rect_initEntityMap (navalmap_t* nmap);
...
int rect_isMovePossible (navalmap_t* nmap,const int shipID,const coord_t moveVec);
...
int *rect_getTargets (navalmap_t *nmap,const coord_t pos,const int dist,int *nbShips);
